        ...
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title"> <i class="fa fa-pencil"></i>
              &nbsp; <?= trans('edit_category_surface') ?> </h3>
            </div>
          ...
          <div class="card-body">
           ...
           <?php echo form_open(base_url('category_surface/edit/'.$catsur['id']), 'class="form-horizontal" enctype="multipart/form-data"' )?> 
          ...
          <div class="col-md-12">
            <select name="CategoryId" id="CategoryId" class="form-control">
              ...
              <?php foreach($categories as $category): ?>
                <option value="<?= $category['id']; ?>" <?php if($catsur['CategoryId']==$category['id']){echo 'selected';}?>><?= $category['name']; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <select name="SurfaceId" id="SurfaceId" class="form-control">
              ...
              <?php foreach($surfaces as $surface): ?>
                <option value="<?= $surface['id']; ?>" <?php if($catsur['SurfaceId']==$surface['id']){echo 'selected';}?>><?= $surface['name']; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
            ...
            <div class="form-group">
              <div class="col-md-12">
                <input type="submit" name="submit" value="<?= trans('update_category_surface') ?>" class="btn btn-primary pull-right">
              </div>
            </div>
            <?php echo form_close(); ?>
          </div>
