    ...
    <div class="col-md-12">
      <div class="box box-body with-border">
        ...
        <div class="col-md-6 text-right">
          <a href="<?= base_url('location/city'); ?>" class="btn btn-success"><i class="fa fa-list"></i> City List</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="box border-top-solid">
        ...
        <div class="box-body my-form-body">
            ...
            <?php echo form_open(base_url('location/city/add'), 'class="form-horizontal"');  ?> 
