    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('location/state'); ?>" class="btn btn-success"><i class="fa fa-list"></i> States List</a>
        </div>
      </div>
      <div class="card-body">
        <?php echo validation_errors(); ?>           
        <?php echo form_open(base_url('location/state/add'), 'class="form-horizontal"');  ?> 
