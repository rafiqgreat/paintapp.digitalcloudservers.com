				...
				<div class="row">
					<div class="col-md-12">
						<div class="pull-right">  
							...
							<a href="<?= base_url('invoices/edit/'.$invoice_detail['id']); ?>" class="btn btn-success"><i class="fa fa-pencil"></i> <?= trans('invoice') ?> ID</a>
		                
							<a class="btn btn-primary create_pdf" 
		                    href="<?= base_url('invoices/invoice_pdf_download/'.$invoice_detail['id']); ?>"><i class="fa fa-download"></i> <?= trans('download') ?></a>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="pull-right">  
							...
							<a href="<?= base_url('invoices/edit/'.$invoice_detail['id']); ?>" class="btn btn-success"><i class="fa fa-pencil"></i> <?= trans('edit_invoice') ?></a>
...
<script type="text/javascript">
	...
	$('.emailView').click(function(e) {
	   ...
	   var csrf = {
	    ...
	    $.ajax({
	        type: "POST",
	        url: "<?= site_url(); ?>invoices/create_pdf/"+id,
			data: csrf,
	...
	$('.sendEmail').click(function(e) {
	    ...
	    $.ajax({
				type: 'POST',
				url: '<?= site_url("invoices/send_email_with_invoice"); ?>',
