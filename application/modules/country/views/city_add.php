        ...
        <div class="card-header">
          <div class="d-inline-block">
           ...
           <div class="d-inline-block float-right">
            <a href="<?= base_url('country/city'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  <?= trans('city_list') ?></a>
          </div>
        </div>
        <div class="card-body">
         ...
         <?php echo form_open(base_url('country/city_add'), 'class="form-horizontal" enctype="multipart/form-data"');  ?> 
...
<script>
    $(document).ready(function(){
        $('#name').on('change', function(){
            var name = $(this).val();
            $.ajax({
                url: '<?php echo base_url("country/check_name_exist_city"); ?>',
                method: 'POST',
                data: {name: name},
