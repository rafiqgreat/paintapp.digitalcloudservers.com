      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <?php if($this->rbac->check_operation_permission('city_add')): ?>
            <a href="<?= base_url('location/city/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New City</a>
          <?php endif; ?>
        </div>
      </div>
      <div class="card-body">
          <?php echo validation_errors(); ?>           
          <?php echo form_open(base_url('location/city/edit/'.$city['id']), 'class="form-horizontal"');  ?> 
