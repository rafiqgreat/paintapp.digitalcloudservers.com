      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('invoices'); ?>" class="btn btn-success"><i class="fa fa-list"></i> <?= trans('invoice_list') ?></a>
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open( base_url('invoices/edit/'.$invoice_detail['id'])); ?>
            <div class="row">  
                <div class="col-md-6">
                  <div class="card">
  ...
  <script type="text/javascript">
    $(function(){
      ...
      $('#customer').change(function(e){
        ...
        $.ajax({
          type: 'POST',
          url: '<?= base_url("invoices/customer_detail/"); ?>'+id,
          data: post_data,
