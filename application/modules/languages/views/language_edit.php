    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('languages'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Languages List</a>
        </div>
      </div>
      <div class="card-body">
        <?php echo form_open(base_url('languages/edit/'.$language['id']), 'class="form-horizontal"' )?>
