    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('example/create_users_pdf') ?>" class="btn btn-success"><?= trans('export_as_pdf') ?></a>
          <a href="<?= base_url('example/export_csv') ?>" class="btn btn-success"><?= trans('export_as_csv') ?></a>
        </div>
      </div>
    </div>
      ...
      <div class="card-body table-responsive"> 
        ...
        <div class="row">
          ...
          <div class="col-md-2"> 
            ...
            <a href="<?= base_url('example/advance_search'); ?>" class="btn btn-danger" style="margin-top:20px;">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('example/advance_datatable_json')?>",
    "order": [[4,'desc']],
    "columnDefs": [
  ...
  function user_filter()
  {
    ...
    $.ajax({
      data: _form,
      type: 'post',
      url: '<?php echo base_url();?>example/search',
      async: true,
