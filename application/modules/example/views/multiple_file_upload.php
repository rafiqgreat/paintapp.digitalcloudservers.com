    ...
    <?php $this->load->view('template/_messages.php') ?>
 		...
 		<div class="card">
 			<div class="card-body table-responsive">
 				...
 				<!-- Upload  -->
				<?php echo form_open_multipart(base_url('example/multi_file_upload'), 'class="dropzone" id="myDropzone"');?>
				...
				<table id="example1" class="table table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $file['name'] ?></td>
							<td>
								<a href="<?= base_url('example/delete_file/'.$file['id']) ?>" class="btn btn-danger btn-delete btn-sm"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
