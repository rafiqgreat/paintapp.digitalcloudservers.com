      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin_roles/module'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  <?= trans('module_list') ?></a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin_roles/module_edit/'.$module['module_id']), 'class="form-horizontal"');  ?> 
