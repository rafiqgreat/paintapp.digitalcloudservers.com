    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <a href="<?= base_url('location'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Country List</a>
          <?php if($this->rbac->check_operation_permission('add')): ?>
            <a href="<?= base_url('location/country/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Country</a>
          <?php endif; ?>
        </div>
      </div>
      <div class="card-body">
        <?php validation_errors(); ?>
        <?php echo form_open(base_url('location/country/edit/'.$country['id']), 'class="form-horizontal"' )?> 
