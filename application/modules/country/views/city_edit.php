    ...
    <div class="card card-default">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right"> <a href="<?= base_url('city'); ?>" class="btn btn-success"><i class="fa fa-list"></i>
          ...
          <a href="<?= base_url('country/city_add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add_new_city') ?></a>
          <?php //endif; ?>
        </div>
      </div>
      <div class="card-body"> 
        ...
        <?php echo form_open(base_url('country/city_edit/'.$city['id']), 'class="form-horizontal"' )?>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            ...
            <select name="state_id" id="state_id" class="form-control" required>
            	...
            	<?php 
				$states = $this->country_model->get_state_by_country_id($city['CountryId']);
				if(!empty($states)){
...
$(document).on("change", "#CountryId", function(){
	$.post( '<?=base_url("country/state_by_country")?>', {
