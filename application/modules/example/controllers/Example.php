...
class example extends MY_Controller {
	...
	public function __construct(){
		...
		$this->load->model('example_model', 'example_model');
	...
	public function ajax_datatable(){
		...
		$this->load->view('example/ajax_datatable');
	...
	public function simple_datatable(){
		...
		$this->load->view('template/_header');
		$this->load->view('example/simple_datatable', $data);
		$this->load->view('template/_footer');
	}
	...
	public function pagination(){
		...
		$this->load->view('template/_header');
		$this->load->view('example/pagination', $data);
		$this->load->view('template/_footer');
	}
	...
	public function advance_search(){
		...
		$this->load->view('template/_header');
		$this->load->view('example/advance_search', $data);
		$this->load->view('template/_footer');
	}
	...
	public function file_upload(){
		...
		if($this->input->post('submit')){
			...
			if($this->upload->do_upload())
			{
				...
				$this->load->view('template/_header');
				$this->load->view('example/file_upload', $data);
				$this->load->view('template/_footer');
			}
			else
			{
	...
	public function multi_file_upload(){
		if($_FILES){
			...
			$this->load->view('template/_header');
			$this->load->view('example/multiple_file_upload', $data);
			$this->load->view('template/_footer');
		}
	}
	...
	public function delete_file($id ='')
	{
		...
		redirect(base_url('example/multi_file_upload'));
	}
	...
	public function create_users_pdf(){
		...
		$this->load->view('example/users_pdf', $data);
	}
	...
	public function charts()
	{
		...
		$this->load->view('template/_header');
		$this->load->view('example/charts',$data);
		$this->load->view('template/_footer');
	}
	...
	public function locations()
	{
		...
		$this->load->view('template/_header');
		$this->load->view('example/locations',$data);
		$this->load->view('template/_footer');
	}
