      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <?php if($this->rbac->check_operation_permission('state_add')): ?>
            <a href="<?= base_url('location/state/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New State</a>
          <?php endif; ?>
        </div>
      </div>
       <!-- form start -->
        <div class="card-body">
            ...
            <?php echo form_open(base_url('location/state/edit/'.$state['id']), 'class="form-horizontal"');  ?> 
